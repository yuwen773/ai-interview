...
| 文档 | 说明 |
|------|------|
| [项目概述](./docs/01-项目概述.md) | 项目简介、功能特性、系统架构 |
| [技术架构](./docs/02-技术架构.md) | 技术栈、分层架构、设计模式 |
| [数据模型](./docs/03-数据模型.md) | 数据库设计、实体关系、DTO定义 |
| [API文档](./docs/04-API文档.md) | RESTful API 接口规范 |
| [开发指南](./docs/05-开发指南.md) | 本地开发、代码规范、调试技巧 |
| [部署指南](./docs/06-部署指南.md) | 生产环境部署、Docker/K8s配置 |
| [二次开发指南](./docs/07-二次开发指南.md) | 扩展点说明、开发示例 |

### 快速导航

- **新手入门**: 阅读 [01-项目概述](./docs/01-项目概述.md) 和 [05-开发指南](./docs/05-开发指南.md)
- **API对接**: 查看 [04-API文档](./docs/04-API文档.md)
- **二次开发**: 参考 [07-二次开发指南](./docs/07-二次开发指南.md)
- **生产部署**: 参考 [06-部署指南](./docs/06-部署指南.md)
