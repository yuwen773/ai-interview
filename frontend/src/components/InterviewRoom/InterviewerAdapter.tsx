...
export function InterviewerAdapter({ type, mode, mouthOpen, className }: InterviewerAdapterProps) {
  // 当前只支持 2D
  if (type === '3d') {
    // TODO: 实现 3D 面试官
  ...
  return <Interviewer2D mode={mode} mouthOpen={mouthOpen} className={className} />;
}
