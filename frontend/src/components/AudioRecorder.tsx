...
export default function AudioRecorder({
  ...
  return (
    <div className="relative flex items-center justify-center">
      ...
      {isRecording && (
        <div
          className="absolute rounded-full border border-[var(--color-primary)]/50 pointer-events-none transition-all duration-75"
          style={{
      ...
      <button
        ...
        className={`
          ...
          ${isRecording
            ? 'bg-[var(--color-primary)] hover:bg-[var(--color-primary-hover)] shadow-[var(--color-primary)]/40'
